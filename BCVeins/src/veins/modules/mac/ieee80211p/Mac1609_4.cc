...
void Mac1609_4::finish()
{
    ...
    //edited by weilu
    double PLR = (statsSNIRLostPackets + statsTXRXLostPackets) * 1.0 / (statsSNIRLostPackets + statsTXRXLostPackets +
            statsReceivedPackets+statsReceivedBroadcasts);
    recordScalar("PacketLossRatio",PLR);
}
