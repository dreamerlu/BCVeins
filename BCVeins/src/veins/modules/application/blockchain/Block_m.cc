...
Block::Block(const char *name, short kind) : ::veins::BaseFrame1609_4(name, kind)
{
}

Block::Block(const Block& other) : ::veins::BaseFrame1609_4(other)
{
    copy(other);
}
...
{
    return this->previousBlockHash.c_str();
}

void Block::setPreviousBlockHash(const char * previousBlockHash)
{
    this->previousBlockHash = previousBlockHash;
}

omnetpp::simtime_t Block::getTimestamp() const
{
    return this->timestamp;
}

void Block::setTimestamp(omnetpp::simtime_t timestamp)
{
    this->timestamp = timestamp;
}

int Block::getDifficultyLevel() const
{
    return this->difficultyLevel;
}

void Block::setDifficultyLevel(int difficultyLevel)
{
    this->difficultyLevel = difficultyLevel;
}

const char * Block::getMiner() const
{
    return this->miner.c_str();
}

void Block::setMiner(const char * miner)
{
    this->miner = miner;
}
...
const char * Block::getTransactionData() const
{
    return this->transactionData.c_str();
}

void Block::setTransactionData(const char * transactionData)
{
...
BlockDescriptor::BlockDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(veins::Block)), "veins::BaseFrame1609_4")
{
...
int BlockDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "previousBlockHash") == 0) return baseIndex + 0;
    if (strcmp(fieldName, "timestamp") == 0) return baseIndex + 1;
    if (strcmp(fieldName, "difficultyLevel") == 0) return baseIndex + 2;
...
const char *BlockDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        "string",    // FIELD_previousBlockHash
...
std::string BlockDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    Block *pp = omnetpp::fromAnyPtr<Block>(object); (void)pp;
    switch (field) {
        case FIELD_previousBlockHash: return oppstring2string(pp->getPreviousBlockHash());
...
void BlockDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    Block *pp = omnetpp::fromAnyPtr<Block>(object); (void)pp;
    switch (field) {
        case FIELD_previousBlockHash: pp->setPreviousBlockHash((value)); break;
...
void BlockDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    Block *pp = omnetpp::fromAnyPtr<Block>(object); (void)pp;
    switch (field) {
        case FIELD_previousBlockHash: pp->setPreviousBlockHash(value.stringValue()); break;
