...
Register_Class(PoWResult)

PoWResult::PoWResult(const char *name, short kind) : ::veins::UnicastMessage(name, kind)
{
}

PoWResult::PoWResult(const PoWResult& other) : ::veins::UnicastMessage(other)
{
    copy(other);
}
...
PoWResult& PoWResult::operator=(const PoWResult& other)
{
    if (this == &other) return *this;
    ::veins::UnicastMessage::operator=(other);
    copy(other);
    return *this;
}

void PoWResult::copy(const PoWResult& other)
{
...
{
    ::veins::UnicastMessage::parsimPack(b);
...
{
    ::veins::UnicastMessage::parsimUnpack(b);
...
void PoWResult::setRsuId(int rsuId)
{
    this->rsuId = rsuId;
}

const char * PoWResult::getBlockData() const
{
    return this->blockData.c_str();
}

void PoWResult::setBlockData(const char * blockData)
{
    this->blockData = blockData;
}

const char * PoWResult::getHash() const
{
    return this->hash.c_str();
}

void PoWResult::setHash(const char * hash)
{
    this->hash = hash;
}

int PoWResult::getNonce() const
{
    return this->nonce;
}

void PoWResult::setNonce(int nonce)
{
    this->nonce = nonce;
}

omnetpp::simtime_t PoWResult::getTimestamp() const
{
    return this->timestamp;
}

void PoWResult::setTimestamp(omnetpp::simtime_t timestamp)
{
    this->timestamp = timestamp;
}

int PoWResult::getDifficultyLevel() const
{
    return this->difficultyLevel;
}

void PoWResult::setDifficultyLevel(int difficultyLevel)
{
...
Register_ClassDescriptor(PoWResultDescriptor)

PoWResultDescriptor::PoWResultDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(veins::PoWResult)), "veins::UnicastMessage")
{
    propertyNames = nullptr;
}

PoWResultDescriptor::~PoWResultDescriptor()
{
    delete[] propertyNames;
}

bool PoWResultDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<PoWResult *>(obj)!=nullptr;
}

const char **PoWResultDescriptor::getPropertyNames() const
{
    if (!propertyNames) {
...
const char *PoWResultDescriptor::getProperty(const char *propertyName) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
...
int PoWResultDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "blockData") == 0) return baseIndex + 1;
    if (strcmp(fieldName, "hash") == 0) return baseIndex + 2;
...
const char *PoWResultDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
const char *PoWResultDescriptor::getFieldProperty(int field, const char *propertyName) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
int PoWResultDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    PoWResult *pp = omnetpp::fromAnyPtr<PoWResult>(object); (void)pp;
    switch (field) {
        default: return 0;
    }
}

void PoWResultDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    PoWResult *pp = omnetpp::fromAnyPtr<PoWResult>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot set array size of field %d of class 'PoWResult'", field);
    }
}

const char *PoWResultDescriptor::getFieldDynamicTypeString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
std::string PoWResultDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void PoWResultDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
...
omnetpp::cValue PoWResultDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void PoWResultDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
...
const char *PoWResultDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
omnetpp::any_ptr PoWResultDescriptor::getFieldStructValuePointer(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void PoWResultDescriptor::setFieldStructValuePointer(omnetpp::any_ptr object, int field, int i, omnetpp::any_ptr ptr) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
