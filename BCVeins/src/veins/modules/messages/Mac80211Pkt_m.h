...
class VEINS_API Mac80211Pkt : public ::veins::MacPkt
{
  ...
  protected:
    bool operator==(const Mac80211Pkt&) = delete;
...
template<> inline veins::Mac80211Pkt *fromAnyPtr(any_ptr ptr) { return check_and_cast<veins::Mac80211Pkt*>(ptr.get<cObject>()); }
}  // namespace omnetpp
