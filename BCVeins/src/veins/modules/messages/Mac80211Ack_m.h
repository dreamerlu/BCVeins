...
#include "veins/modules/messages/Mac80211Pkt_m.h" // import veins.modules.messages.Mac80211Pkt


namespace veins {

/**
 * Class generated from <tt>veins/modules/messages/Mac80211Ack.msg:27</tt> by nedtool.
 * <pre>
...
class VEINS_API Mac80211Ack : public ::veins::Mac80211Pkt
{
  ...
  protected:
    bool operator==(const Mac80211Ack&) = delete;
...
template<> inline veins::Mac80211Ack *fromAnyPtr(any_ptr ptr) { return check_and_cast<veins::Mac80211Ack*>(ptr.get<cObject>()); }
}  // namespace omnetpp
