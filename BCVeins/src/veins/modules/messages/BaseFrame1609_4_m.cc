//
// Generated file, do not edit! Created by nedtool 6.0 from ./veins/modules/messages/BaseFrame1609_4.msg.
//
...
std::string BaseFrame1609_4Descriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_recipientAddress: {std::stringstream out; out << pp->getRecipientAddress(); return out.str();}
        default: return "";
    }
}
