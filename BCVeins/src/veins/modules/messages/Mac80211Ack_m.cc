//
// Generated file, do not edit! Created by nedtool 6.0 from veins/modules/messages/Mac80211Ack.msg.
//
...
Mac80211AckDescriptor::Mac80211AckDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(veins::Mac80211Ack)), "veins::Mac80211Pkt")
{
...
int Mac80211AckDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    Mac80211Ack *pp = omnetpp::fromAnyPtr<Mac80211Ack>(object); (void)pp;
    switch (field) {
        default: return 0;
    }
}

void Mac80211AckDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    Mac80211Ack *pp = omnetpp::fromAnyPtr<Mac80211Ack>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot set array size of field %d of class 'Mac80211Ack'", field);
    }
}

const char *Mac80211AckDescriptor::getFieldDynamicTypeString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
std::string Mac80211AckDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void Mac80211AckDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    switch (field) {
        ...
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'Mac80211Ack'", field);
    }
}

omnetpp::cValue Mac80211AckDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    Mac80211Ack *pp = omnetpp::fromAnyPtr<Mac80211Ack>(object); (void)pp;
    switch (field) {
        case FIELD_messageId: return omnetpp::checked_int_cast<omnetpp::intval_t>(pp->getMessageId());
        default: throw omnetpp::cRuntimeError("Cannot return field %d of class 'Mac80211Ack' as cValue -- field index out of range?", field);
    }
}

void Mac80211AckDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    Mac80211Ack *pp = omnetpp::fromAnyPtr<Mac80211Ack>(object); (void)pp;
    switch (field) {
        case FIELD_messageId: pp->setMessageId(omnetpp::checked_int_cast<unsigned long>(value.intValue())); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'Mac80211Ack'", field);
    }
}
...
omnetpp::any_ptr Mac80211AckDescriptor::getFieldStructValuePointer(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void Mac80211AckDescriptor::setFieldStructValuePointer(omnetpp::any_ptr object, int field, int i, omnetpp::any_ptr ptr) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
