//
// Generated file, do not edit! Created by nedtool 6.0 from veins/modules/messages/PhyControlMessage.msg.
//
...
PhyControlMessageDescriptor::PhyControlMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(veins::PhyControlMessage)), "omnetpp::cMessage")
{
...
unsigned int PhyControlMessageDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_txPower_mW
    };
...
int PhyControlMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "mcs") == 0) return baseIndex + 0;
    if (strcmp(fieldName, "txPower_mW") == 0) return baseIndex + 1;
...
int PhyControlMessageDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    PhyControlMessage *pp = omnetpp::fromAnyPtr<PhyControlMessage>(object); (void)pp;
    switch (field) {
        default: return 0;
    }
}

void PhyControlMessageDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    PhyControlMessage *pp = omnetpp::fromAnyPtr<PhyControlMessage>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot set array size of field %d of class 'PhyControlMessage'", field);
    }
}

const char *PhyControlMessageDescriptor::getFieldDynamicTypeString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
std::string PhyControlMessageDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    switch (field) {
        ...
        case FIELD_txPower_mW: return double2string(pp->getTxPower_mW());
        default: return "";
    }
}

void PhyControlMessageDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    switch (field) {
        ...
        case FIELD_txPower_mW: pp->setTxPower_mW(string2double(value)); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'PhyControlMessage'", field);
    }
}

omnetpp::cValue PhyControlMessageDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    switch (field) {
        ...
        case FIELD_txPower_mW: return pp->getTxPower_mW();
        default: throw omnetpp::cRuntimeError("Cannot return field %d of class 'PhyControlMessage' as cValue -- field index out of range?", field);
    }
}

void PhyControlMessageDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    switch (field) {
        ...
        case FIELD_txPower_mW: pp->setTxPower_mW(value.doubleValue()); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'PhyControlMessage'", field);
    }
}
...
omnetpp::any_ptr PhyControlMessageDescriptor::getFieldStructValuePointer(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void PhyControlMessageDescriptor::setFieldStructValuePointer(omnetpp::any_ptr object, int field, int i, omnetpp::any_ptr ptr) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
