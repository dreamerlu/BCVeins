//
// Generated file, do not edit! Created by nedtool 6.0 from veins/base/messages/MacPkt.msg.
//
...
std::string MacPktDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    MacPkt *pp = omnetpp::fromAnyPtr<MacPkt>(object); (void)pp;
    switch (field) {
        case FIELD_destAddr: {std::stringstream out; out << pp->getDestAddr(); return out.str();}
        case FIELD_srcAddr: {std::stringstream out; out << pp->getSrcAddr(); return out.str();}
