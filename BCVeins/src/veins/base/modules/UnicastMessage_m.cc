...
UnicastMessage::UnicastMessage(const char *name, short kind) : ::omnetpp::cMessage(name, kind)
{
}

UnicastMessage::UnicastMessage(const UnicastMessage& other) : ::omnetpp::cMessage(other)
{
    copy(other);
}
...
int UnicastMessage::getTargetRSUId() const
{
    return this->targetRSUId;
}

void UnicastMessage::setTargetRSUId(int targetRSUId)
{
    this->targetRSUId = targetRSUId;
}

const char * UnicastMessage::getDescrp() const
{
    return this->descrp.c_str();
}

void UnicastMessage::setDescrp(const char * descrp)
{
    this->descrp = descrp;
}
...
UnicastMessageDescriptor::UnicastMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(veins::UnicastMessage)), "omnetpp::cMessage")
{
...
int UnicastMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "targetRSUId") == 0) return baseIndex + 0;
    if (strcmp(fieldName, "descrp") == 0) return baseIndex + 1;
...
int UnicastMessageDescriptor::getFieldArraySize(omnetpp::any_ptr object, int field) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void UnicastMessageDescriptor::setFieldArraySize(omnetpp::any_ptr object, int field, int size) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    UnicastMessage *pp = omnetpp::fromAnyPtr<UnicastMessage>(object); (void)pp;
    switch (field) {
        default: throw omnetpp::cRuntimeError("Cannot set array size of field %d of class 'UnicastMessage'", field);
    }
}

const char *UnicastMessageDescriptor::getFieldDynamicTypeString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
std::string UnicastMessageDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    UnicastMessage *pp = omnetpp::fromAnyPtr<UnicastMessage>(object); (void)pp;
    switch (field) {
        case FIELD_targetRSUId: return long2string(pp->getTargetRSUId());
...
void UnicastMessageDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
    ...
    UnicastMessage *pp = omnetpp::fromAnyPtr<UnicastMessage>(object); (void)pp;
    switch (field) {
        case FIELD_targetRSUId: pp->setTargetRSUId(string2long(value)); break;
...
omnetpp::cValue UnicastMessageDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
    ...
    switch (field) {
        ...
        default: throw omnetpp::cRuntimeError("Cannot return field %d of class 'UnicastMessage' as cValue -- field index out of range?", field);
    }
}

void UnicastMessageDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
...
omnetpp::any_ptr UnicastMessageDescriptor::getFieldStructValuePointer(omnetpp::any_ptr object, int field, int i) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount())
...
void UnicastMessageDescriptor::setFieldStructValuePointer(omnetpp::any_ptr object, int field, int i, omnetpp::any_ptr ptr) const
{
    omnetpp::cClassDescriptor *base = getBaseClassDescriptor();
    if (base) {
        if (field < base->getFieldCount()){
